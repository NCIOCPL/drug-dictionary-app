...
describe('getAutoSuggestResults action', () => {
	it(`should match getAutoSuggestResults action with Begins for searchText "ace"`, () => {
	...
	it(`should match getAutoSuggestResults action with Contains for searchText "ace"`, () => {
		const searchText = 'ace';
		const retAction = {
			method: 'GET',
