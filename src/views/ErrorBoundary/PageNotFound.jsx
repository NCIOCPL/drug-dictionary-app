...
const PageNotFound = () => {
	const [{ canonicalHost, language, analyticsName, dictionaryTitle }] = useStateValue();
		...
		<>
			...
			<div className="error-container">
				...
				<form name="kwSearch" className="error-searchbar">
					<input id="keywords" type="text" className="ncids-input searchString" aria-required="false" aria-label={i18n.search[language]} autoComplete="off" onChange={(event) => setSearchText(event.target.value)} />
